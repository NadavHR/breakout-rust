...
impl Bricks {
    pub fn new(display_dimensions: Dimensions, gameplay_dimensions: Dimensions, brick_initial_life: u8, brick_dimensions: Dimensions) -> Bricks {
        let buffer = (0..gameplay_dimensions.height * gameplay_dimensions.width).map(|_| brick_initial_life).collect();
    ...
    pub fn calc_ball_collision(&mut self, ball_pos: (u32, u32)) {
